<header class="mx-auto" >
    <div class="navbar">
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                <!-- Navigation BURGER (pour les versions mobile) -->
                        ...
                        for ($i = 0; $i < count($_Menu_['MenuTexte']); $i++) :
                            ...
                            if (isset($_Menu_['MenuListeDeroulante'][$_Menu_['MenuTexteBB'][$i]])) :
                                ...
                                <li class="nav-item submenu dropdown">
                                    <a href="#" id="Listdefil<?php echo $i; ?>" class="nav-link dropdown-toggle"
                                       ...
                                       aria-expanded="false"><?php echo $_Menu_['MenuTexte'][$i]; ?></a>
                                    <ul class="dropdown-menu" aria-labelledby="Listdefil<?php echo $i; ?>">
                                        ...
                                        for ($k = 0; $k < count($_Menu_['MenuListeDeroulante'][$_Menu_['MenuTexteBB'][$i]]); $k++) :
                                            ...
                                            <?php else : ?>
                                                ...
                                                <li class="nav-item"><a
                                                            href="<?= $_Menu_['MenuListeDeroulanteLien'][$_Menu_['MenuTexteBB'][$i]][$k] ?>"
                                                            class="nav-link"> <?= $_Menu_['MenuListeDeroulante'][$_Menu_['MenuTexteBB'][$i]][$k] ?></a>
                                                </li>
                            ...
                            <?php else :
                                ...
                                <li class="nav-item<?= $active ?>">
                                    <a href="<?= $_Menu_['MenuLien'][$i] ?>"
                                       class="nav-link"><?= $_Menu_['MenuTexte'][$i] ?></a>
                                </li>
                            <?php endif;
                        endfor; ?>
                                    ...
                                    <li class="nav-item dropdown ml-auto">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="profil-<?= $_Joueur_['pseudo']; ?>">
                                            ...
                                            <a class="dropdown-item"
                                               href="?page=profil&profil=<?= $_Joueur_['pseudo']; ?>"><i
                                            ...
                                            <?php if (Permission::getInstance()->verifPerm('PermsForum', 'moderation', 'seeSignalement')) :
                                                ...
                                                <!-- Signalements -->
                                                <a href="?page=signalement" class="dropdown-item text-warning"><i
                                                            class="fa fa-bell"></i> Signalement <span
                                                            class="badge badge-pill badge-warning"
                                                            id="signalement"><?= $signalement ?></span></a>
                                            <?php endif; ?>
                                            <a class="dropdown-item" href="?page=alert"><i class="fa fa-bell"></i>
                                                Alertes : <span class="badge badge-pill badge-primary"
                                                                id="alerts"><?= $alerte; ?></span></a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="?page=token"></i> Mon solde
                                                : <?php if (isset($_Joueur_['tokens'])) echo $_Joueur_['tokens']; ?> <i
                                                        class="fas fa-gem"></i></a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item text-danger" href="?action=deco"><i
