                    ...
                    <div class="form-row py-2">
                        ...
                        <div class="col-md-6">
                            <button type="button"
                                    ...
                                    class="btn btn-reverse" style="margin-top:35px">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <?php if ($newsComments['pseudo'] == $_Joueur_['pseudo'] or Permission::getInstance()->verifPerm("createur")) : ?>
                                                        ...
                                                        <a class="dropdown-item text-danger"
                                                           href="?&action=delete_news_commentaire&id_comm=<?= $newsComments['id'] ?>&id_news=<?= $news[$i]['id'] ?>&auteur=<?= $newsComments['pseudo'] ?>">
                                                            Supprimer
                                                        </a>
                                                    ...
                                                    <?php if ($newsComments['pseudo'] != $_Joueur_['pseudo']) :
                                                        if ($checkReport == "0") : ?>
                                                            <a class="dropdown-item"
                                                               href="?&action=report_news_commentaire&id_news=<?= $news[$i]['id'] ?>&id_comm=<?= $newsComments['id'] ?>&victime=<?= $newsComments['pseudo'] ?>">
                                                                Signaler
                                                            </a>
                                                        <?php else : ?>
