            ...
            <section class="page" id="Post">
                <div class="container-fluid col-md-9 col-lg-9 col-sm-10 mt-4">
                    ...
                    <div class="row bg-dark">
                        ...
                        <div class="col-lg-8 col-md-12 col-sm-12 mt-3 p-4 bg-dark rounded ml-auto">
                    ...
                    for ($i = 0; $i < count($answerd); $i++) : ?>
                        ...
                        <div class="row bg-dark" style="margin-top: 25px">
                                ...
                                <form action="?&action=post_answer" method="post">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-12 text-center">
                                            ...
                                            <textarea  data-UUID="0003" id="ckeditorPost" name="contenue" style="height: 750px; margin: 0px; width: 100%;">
                                    ...
                                    <div class="form-row bg-light" style="margin-top:15px;">
                                        <div class="col-12">
