...
if (Permission::getInstance()->verifPerm('PermsForum', 'moderation', 'seeSignalement')) :
    ...
    ?>
    <section class="page" id="Signalement">
        <div class="container-fluid col-md-9 col-lg-9 col-sm-10">
            <div class="row">
                ...
                <div class="d-flex col-12 info-page">
                    ...
                    <div class="mx-auto" style="margin-bottom: 12px">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($data['type'] != 0) :
                                        ...
                                        <a class="btn btn-reverse"
                                           href="index.php?action=r_a_vu&id_a=<?= $data['id_topic_answer']; ?>&id=<?= $id['id_topic']; ?>&page_post=<?= $page; ?>">
                                            Lien vers la réponse
                                        </a>

                                    <?php else : ?>

                                        <a class="btn btn-reverse no-hover"
                                           href="index.php?action=r_t_vu&id=<?= $data['id_topic_answer']; ?>">
                                            Voir le topic</a>
