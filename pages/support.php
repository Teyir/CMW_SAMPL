<section class="page" id="support">
    ...
    <div class="container">
        ...
        <div class="jumbotron bg-dark">
            <p class="lead" style="color: #222121">Bienvenue sur le support, vous retrouverez ici tous les tickets
                ouverts, vous pouvez vous-même en ouvrir un si vous avez souci, ou une question.</p>

            <hr class="my-4" style="max-width: 100%">

            <p style="color: #222121">Une fois que votre ticket a été ouvert, vous pouvez aussi le fermer, ou y répondre
                en y apportant de plus amples informations.</p>
            ...
            <?php else : ?>
                ...
                <button data-toggle="collapse" href="#openticket" role="button" aria-expanded="false"
                        aria-controls="openticket" class="btn btn-primary btn-block">
                    <i class="fas fa-pen-square"></i> Ouvrir un ticket
                </button>


                <!-- Collapse de l'ouverture du ticket -->
                        ...
                        <form action="index.php?action=post_ticket" method="post">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <input type="text" id="titre_ticket"
                                                           class="form-control custom-text-input" name="titre"
                                                           placeholder="Sujet">
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            if (!isset($_Serveur_["support"]["visibilite"]) || $_Serveur_["support"]["visibilite"] == "both") : ?>
                                                <select class="form-control custom-text-input" id="vu_ticket"
                                                        name="ticketDisplay">
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <label for="message_ticket"><i class="fas fa-feather"></i>
                                        Description détaillée</label>
                                    <textarea data-UUID="0007" id="ckeditor" name="message"
                                              style="height: 275px; margin: 0px; width: 100%;">
                                    </textarea>
        ...
        <div style="display:inline-block;">
            <h4>Tickets créés </h4>
            <hr class="my-6 bg-light" style="max-width: 200px"/>
        </div>
        ...
        <table class="table table-hover table-responsive mb-0 mt-4 text-center">
            ...
            <tr class="no-hover">
                <?php if ($tickets['ticketDisplay'] == 0 or $tickets['auteur'] == $_Joueur_['pseudo'] or Permission::getInstance()->verifPerm('PermsDefault', 'support', 'displayTicket')) :
                    if (Permission::getInstance()->verifPerm('PermsDefault', 'support', 'displayTicket')) : ?>
                        <th scope="row" class="text-center align-middle txt-tickets">
                            <?php if ($tickets['ticketDisplay'] == "0") : ?>

                                <i data-toggle="tooltip" data-html="true" title="Ce ticket est <u>public</u>"
                                   class="fas fa-eye"></i>
                            <?php else : ?>
                                <i data-toggle="tooltip" data-html="true" title="Ce ticket est <u>privé</u>"
                                   class="fas fa-eye-slashed"></i>
                            <?php endif; ?>
                        </th>
                    <?php endif; ?>
                ...
                <!-- Pseudo de l'auteur -->
                    <td class="align-middle">
                        <a href="index.php?&page=profil&profil=<?= $tickets['auteur'] ?>">
                            <img class="icon-player-topbar"
                                 src="<?= $_ImgProfil_->getUrlHeadByPseudo($tickets['auteur'], 32) ?>"
                ...
                <!-- Titre du ticket -->
                    <td class="align-middle txt-tickets">
                        <?= $tickets['titre'] ?>​
                    </td>

                <!-- Date de création du ticket -->
                    <td class="align-middle txt-tickets"><?php echo $_Forum_->conversionDate($tickets['date_post']); ?>
                    </td>

                <!-- Modification du ticket-->
                    <td class="align-middle">
                        <a class="btn btn-primary btn-sm rounded" data-toggle="modal"
                           data-target="#slide-<?= $tickets['id']; ?>" data-dismiss="modal" style="color: white">
                ...
                <!-- État du ticket -->
                    ...
                    <td class="text-center align-middle">
                        ...
                        <form class="form-horizontal default-form" method="post"
                              action="?&action=ticketEtat&id=<?= $tickets['id']; ?>">
            ...
            <div class="modal fade" id="slide-<?= $tickets['id']; ?>" tabindex="-1" role="dialog"
                 aria-labelledby="slide-<?= $tickets['id']; ?>" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="media">
                                <p class="username">
                                    <img class="mr-3"
                                         src="<?= $_ImgProfil_->getUrlHeadByPseudo($tickets['auteur'], 32); ?>"
                                         style="width: 32px; height: 32px;" alt="Avatar de <?= $tickets['auteur'] ?>"/>
                                    <div class="media-body">
                                        <h6 class="mt-0 mb-2 font-weight-bold">
                                            <?= $tickets['auteur']; ?> |
                                            le <?= $_Forum_->conversionDate($tickets['date_post']); ?>
                                        </h6>
                                        <?= $message; ?>
                                        ...
                                        for ($i = 0;
                                        $i < count($ticketCommentaires[$tickets['id']]);
                                        $i++) :
                                ...
                                <p class="username">
                                    <img class="mr-3"
                                         src="<?= $_ImgProfil_->getUrlHeadByPseudo($ticketCommentaires[$tickets['id']][$i]['auteur'], 32); ?>"
                                         style="width:32px; height:32px;"
                                         alt="Avatar de <?= $ticketCommentaires[$tickets['id']][$i]['auteur'] ?>"/>
                                <div class="media-body">
                                    <h6 class="mt-0 mb-2 font-weight-bold">
                                        <?= $ticketCommentaires[$tickets['id']][$i]['auteur']; ?> |
                                        le <?= $_Forum_->conversionDate($ticketCommentaires[$tickets['id']][$i]['date_post']); ?>
                                    </h6>
                                    <div id="contenueCom<?= $tickets['id'] ?>-<?= $ticketCommentaires[$tickets['id']][$i]['id'] ?>"
                                    ...
                                    <?php if ((isset($_Joueur_)) && (($ticketCommentaires[$tickets['id']][$i]['auteur'] == $_Joueur_['pseudo'] || Permission::getInstance()->verifPerm('PermsDefault', 'support', 'deleteMemberComm')) || ($ticketCommentaires[$tickets['id']][$i]['auteur'] == $_Joueur_['pseudo'] || Permission::getInstance()->verifPerm('PermsDefault', 'support', 'editMemberComm')))) : ?>
                                        ...
                                        <div class="dropdown">
                                            <a class="btn btn-primary no-hover float-right" data-toggle="dropdown">
                                                Action
                                                <b class="caret"></b></a>
                                            <ul class="dropdown-menu">
                                                ...
                                                <?php if ($ticketCommentaires[$tickets['id']][$i]['auteur'] == $_Joueur_['pseudo'] or Permission::getInstance()->verifPerm('PermsDefault', 'support', 'deleteMemberComm')) : ?>
                                                    ...
                                                    <li>
                                                        <a href="?&action=delete_support_commentaire&id_comm=<?= $ticketCommentaires[$tickets['id']][$i]['id'] ?>&id_ticket=<?= $tickets['id'] ?>&auteur=<?= $ticketCommentaires[$tickets['id']][$i]['auteur'] ?>"
                                                           class="dropdown-item">
                                                            Supprimer
                                                        </a>
                                                    </li>
                                                ...
                                                <?php if ($ticketCommentaires[$tickets['id']][$i]['auteur'] == $_Joueur_['pseudo'] or Permission::getInstance()->verifPerm('PermsDefault', 'support', 'editMemberComm')) : ?>
                                                    <li>
                                                        <a href="#editComm-<?= $ticketCommentaires[$tickets['id']][$i]['id'] ?>"
                                                           data-toggle="modal"
                                                           data-target="#editComm-<?= $ticketCommentaires[$tickets['id']][$i]['id'] ?>"
                                                           class="dropdown-item" data-dismiss="modal">Editer</a>
                                                    </li>
                                                <?php endif; ?>
                                            </ul>
                                        </div>
                                    ...
                                    if ($tickets['etat'] == "0") { ?>
                                        <button type="button"
                                                onclick="addBlockQuote('ckeditorCom<?= $tickets['id'] ?>','contenueCom<?= $tickets['id'] ?>-<?= $ticketCommentaires[$tickets['id']][$i]['id'] ?>', '<?= $ticketCommentaires[$tickets['id']][$i]['auteur']; ?>');"
                                                class="btn btn-dark float-right mb-5" style="margin-right:15px;">
                                            Citer !
                                        </button>
                                    <?php } ?>
                                </div>
                    ...
                    <?php else : ?>
                        ...
                        <div class="alert alert-info">
                            <div class="text-center">
                                Ticket résolu ! Merci de contacter un administrateur pour réouvrir votre ticket.
                            </div>
                        </div>
    ...
    <?php if (isset($ticketCommentaires[$tickets['id']][$i]['auteur']) && $ticketCommentaires[$tickets['id']][$i]['auteur'] == $_Joueur_['pseudo'] or Permission::getInstance()->verifPerm('PermsDefault', 'support', 'editMemberComm')) :
        if (!empty($ticketCommentaires[$tickets['id']])) :
            for ($i = 0; $i < count($ticketCommentaires[$tickets['id']]); $i++) : ?>
                ...
                <div class="modal fade" id="editComm-<?= $ticketCommentaires[$tickets['id']][$i]['id']; ?>"
                     tabindex="-1" role="dialog" aria-labelledby="editComm">
                    <form method="POST"
                          action="?&action=edit_support_commentaire&id_comm=<?= $ticketCommentaires[$tickets['id']][$i]['id']; ?>&id_ticket=<?= $tickets['id']; ?>&auteur=<?= $ticketCommentaires[$tickets['id']][$i]['auteur']; ?>">
                            ...
                            <div class="modal-content border-0">
                                ...
                                <div class="modal-body">
                                    <div class="col-lg-12 text-center">
                                        ...
                                        <div class="row mt-4">
                                            <div style="width:100%;">
                                                <textarea data-UUID="0015" name="editMessage"
