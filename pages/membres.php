...
<section class="page" id="Members">
    <div class="container-fluid col-md-9 col-lg-9 col-sm-10">

        <!-- Barre de recherche -->
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12 mb-3">
                <label for="searchPlayer" class="col-lg-4 col-md-12 col-sm-12 col-form-label">
                ...
                <div class="p-1 bg-light rounded shadow-sm mb-4">
                    <div class="input-group">
                        ...
                        <input onChange="rechercheAjaxMembre();" type="text"
                               placeholder="Ex: Teyir ( Appuyez sur Entrée pour valider )"
                               aria-describedby="button-addon1" class="form-control border-0 bg-light" id="recherche"
                               name="searchPlayer">
                    ...
                    <?php foreach ($membres as $value) : ?>
                        <tr>
                            <td scope="row">
                                <?= $value['id']; ?></td>
                            <td>
                                <img src='<?= $_ImgProfil_->getUrlHeadByPseudo($value['pseudo'], 32); ?>'
                                     style='width: 32px; height: 32px;'
                                     alt='image de profile de <?= $value["pseudo"] ?>'/> <?= $value["pseudo"]; ?>
                            </td>
                            ...
                            <!-- Icone d'envoie vers le profil du joueur -->
                            <td>
                                <a href="?page=profil&profil=<?= $value['pseudo']; ?>" target="_blank"
                                   class="btn btn-reverse "><i class="fas fa-external-link-alt"></i></a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        <?php if ($page > 1) : ?>
                            ...
                            <li class="page-item">
                                <a class="page-link" href="?page=membres&page_membre=<?= $page - 1 ?>"
