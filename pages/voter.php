<section class="page" id="vote">
    <div class="container">
                ...
                <div class="col-12 p-0">
                    ...
                    <div class="card text-white bg-dark mb-4">
                        <div class="card-header">
                            <h4 class="card-title">Entrez votre pseudonyme
                                <strong><?= $_Serveur_['General']['name']; ?></strong></h4>
                        </div>
                        ...
                        <div class="card-body">
                            <form id="forme-vote" role="form" method="GET" action="index.php">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="vote-pseudo" class="form-control" name="player"
                                           placeholder="Pseudo"
                                           value="<?= (Permission::getInstance()->verifPerm("connect")) ? $_Joueur_['pseudo'] : '' ?>"
                                           required>
                                    <div class="input-group-append">
                                        <button class="form-control btn btn-secondary" style="font-size:0.9rem;"
                                                type="submit">Suivant <i class="fas fa-angle-double-right"></i></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                                ...
                                foreach ($lectureJSON as $serveur) { ?>
                                    ...
                                    <div id="voter-<?= $serveur['id']; ?>"
                                        ...
                                        <p><i class="fas fa-info-circle"></i>
                                            Vous votez pour : <b><?= $serveur['nom']; ?></b>
                                        </p>
                                        ...
                                        while ($allvote = $req_vote->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            <button type="button" id="votebtn-<?php echo $allvote['id']; ?>"
        ...
        <table class="table table-hover " id="baltop">
            <!-- theme/Sample/assets/js/voteControleur.js::updateBaltop -->
        </table>
