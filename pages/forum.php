    ...
    <div class="container-fluid col-md-9 col-lg-9 col-sm-10">
            ...
            <div class="info-page col-12">
                <div class="d-flex col-12 col-sm-6 col-lg-4" style="margin:auto;">
                    ...
                    <div class="input-group" style="margin-bottom: 20px">
                        <input type="text" id="search-topic" class="form-control border-0 bg-light"
                               placeholder="Rechercher un topic ou un message"/>
                        <div class="input-group-append">
                                 <span onclick="searchForum(document.getElementById('search-topic').value, document.getElementById('all-search'), document.getElementById('table-search'),document.getElementById('title-search'))"
                                       style="border: none;" class="btn btn-link text-light"
                                       style="cursor:pointer;"><i class="fas fa-search"></i>
                                </span>
                        </div>
                    </div>
        ...
        <div class="row" style="display:none;" id="all-search">
            <table class="table table-dark table-striped"
                ...
                <tr>
                    <th colspan="5"
                        style="width: <?= (Permission::getInstance()->verifPerm('PermsForum', 'general', 'deleteCategorie') and !$_SESSION['mode']) ? '75%' : '100%'; ?>;">
        ...
        <div class="row">
            <!-- Pour passer en mode joueur ou admin -->
            <?php if (Permission::getInstance()->verifPerm('PermsForum', 'general', 'modeJoueur')) : ?>
                <p class="text-center">
                    <a href="?action=mode_joueur" class="btn btn-main w-100">
                        Passer en mode visuel <?= ($_SESSION['mode']) ? "Administrateur" : "Joueur"; ?></a>
                </p>
            <?php endif; ?>
            ...
            <?php for ($i = 0; $i < count($fofo); $i++) :
                if (((Permission::getInstance()->verifPerm('PermsDefault', 'forum', 'perms') >= $fofo[$i]['perms'] or Permission::getInstance()->verifPerm("createur")) and !$_SESSION['mode']) or $fofo[$i]['perms'] == 0) : ?>
                    ...
                    <table class="table table-dark table-hover table-responsive mb-0">
                            ...
                            <?php if (Permission::getInstance()->verifPerm('PermsForum', 'general', 'deleteForum') and !$_SESSION['mode']) : ?>
                                ...
                                <div>
                                    ...
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <button class="btn btn-main dropdown-toggle" type="button"
                                                id="perms<?= $fofo[$i]['id']; ?>" data-toggle="dropdown"
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <form action="?action=modifPermsForum" method="POST">
                                                ...
                                                <a class="dropdown-item"><input type="number" name="perms"
                                                                                value="<?= $fofo[$i]['perms']; ?>"
                                    ...
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <button class="btn btn-main dropdown-toggle" type="button"
                                                id="ordreforum<?= $fofo[$i]['id']; ?>" data-toggle="dropdown"
                                                aria-haspopup="true" aria-expanded="false">
                                            Modifier l'ordre
                                        </button>
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item"
                                               href="?action=ordreForum&ordre=<?= $fofo[$i]['ordre']; ?>&id=<?= $fofo[$i]['id']; ?>&modif=monter">
                                                <i class="fas fa-arrow-up"></i> Monter d'un cran
                                            </a>
                                            <a class="dropdown-item"
                                               href="?action=ordreForum&ordre=<?= $fofo[$i]['ordre']; ?>&id=<?= $fofo[$i]['id']; ?>&modif=descendre">
                        ...
                        <tr>
                            <th colspan="5"
                                ...
                                <h5 class="text-center"
                                    <?php if (Permission::getInstance()->verifPerm('PermsForum', 'general', 'deleteForum') and !$_SESSION['mode']) { ?>data-editforum-index="<?= $i; ?>"
                                    data-editforum="<?php echo $fofo[$i]['id']; ?>" <?php } ?>>
                                    <span style="display:inline;"><?= ucfirst($fofo[$i]['nom']); ?></span> <input
                                            type="text" class="text-center no-hover"
                                            value="<?= ucfirst($fofo[$i]['nom']); ?>"
                                            style="width:auto;color:white;display:none;background: transparent;border: none;">
                                    <i style="display:none;" style="cursor:pointer" class="fas fa-cog"></i>
                                </h5>
                            </th>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 3%;">
                                        <?php if ($categorie[$j]['img'] == NULL) : ?>
                                            <a href="?&page=forum_categorie&id=<?= $categorie[$j]['id']; ?>"
                                               style="font-size: 38px;" class="d-flex align-self-center text-center">
                                            ...
                                            <small>
                                                <div class="dropdown">
                                                    <a class="dropdown-toggle"
                                                       href="sous-forum<?= $categorie[$j]['id']; ?>"
                                                    ...
                                                    <?php if (count($sousforum) != "0") : ?>
                                                        <div class="dropdown-menu"
                                                             aria-labelledby="sous-forum<?php echo $categorie[$j]['id']; ?>">
                                                            <?php for ($s = 0; $s < count($sousforum); $s++) : ?>
                                                                <a class="dropdown-item"
                                                                   href="?&page=forum_categorie&id=<?= $categorie[$j]['id']; ?>&id_sous_forum=<?= $sousforum[$s]['id']; ?>">
                                                                    <?= $sousforum[$s]['nom']; ?>
                                                                </a>
                                                            <?php endfor; ?>
                                                        </div>
                                    ...
                                    <td class="text-center">
                                        <?php if ($derniereReponse) : ?>
                                            <a href="?page=post&id=<?= $derniereReponse['id']; ?>"
                                               title="<?= $derniereReponse['titre']; ?>">
                                        ...
                                        <td>
                                            ...
                                            <div class="mx-auto d-flex align-self-center">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <form action="?action=modifPermsCategorie" method="POST">
                                                            <input type="hidden" name="id"
                                                                   value="<?= $categorie[$j]['id']; ?>"/>
                                                            <a class="dropdown-item">
                                                                <input type="number" name="perms"
                                                                       value="<?= $categorie[$j]['perms']; ?>"
                                                                       class="form-control custom-text-input">
                                                            </a>
                                                            <button type="submit"
                                                                    class="dropdown-item text-center btn btn-reverse w-80 mx-auto mt-3">
                                                                Modifier
                                                            </button>
                                                        </form>
                                                    </div>
                                                ...
                                                <div class="dropdown d-inline ml-1">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item"
                                                           href="?action=ordreCat&ordre=<?= $categorie[$j]['ordre']; ?>&id=<?= $categorie[$j]['id']; ?>&forum=<?= $categorie[$j]['forum']; ?>&modif=monter">
                                                            <i class="fas fa-arrow-up"></i> Monter d'un cran
                                                        </a>
                                                        <a class="dropdown-item"
                                                           href="?action=ordreCat&ordre=<?= $categorie[$j]['ordre']; ?>&id=<?= $categorie[$j]['id']; ?>&forum=<?= $categorie[$j]['forum']; ?>&modif=descendre">
                                                            <i class="fas fa-arrow-down"></i> Descendre d'un cran
                                                        </a>
                                                    </div>
                                                </div>

                                                <!-- Modification du forum (formulaire disponible dans le fichier formulaires.php -->
                                                <button type="button"
                                                        onclick="openModalEditForum(<?= $categorie[$j]['id']; ?>,'<?= $categorie[$j]['nom']; ?>',<?php echo $fofo[$i]['id']; ?>, <?php if ($categorie[$j]['img'] == NULL) {
                                                            echo 'null';
                                                        } else {
                                                            echo "'" . $categorie[$j]['img'] . "'";
                                                        } ?> );" class="btn btn-main ml-1">
                                                    <i class="fas fa-cog"></i>
                                                </button>


                                                <!-- Fermer ou non le forum -->
                                                <?php if ($categorie[$j]['close'] == 0) : ?>

                                                    <a href="?action=lock_cat&id=<?= $categorie[$j]['id']; ?>&lock=1"
                                                       title="Fermer le forum" class="btn btn-reverse ml-1 no-hover">
                                                        <i class="fas fa-unlock-alt" aria-hidden="true"></i>
                                                    </a>

                                                <?php else : ?>

                                                    <a href="?action=unlock_cat&id=<?= $categorie[$j]['id']; ?>&lock=0"
                                                       title="Ouvrir le forum" class="btn btn-reverse ml-1 no-hover">
                                                ...
                                                <!-- Supprimer le forum -->
                                                <a href="?action=remove_cat&id=<?= $categorie[$j]['id']; ?>"
                                                   class="btn btn-danger no-hover ml-1">
        ...
        <div class="row">
            <?php if (Permission::getInstance()->verifPerm('PermsForum', 'general', 'addForum') and !$_SESSION['mode']) : ?>
                ...
                <a class="btn btn-reverse no-hover col-5 mr-auto bg-light" role="button" data-toggle="collapse" href="#add_forum"
                   aria-expanded="false" aria-controls="add_forum">
            ...
            <?php if (Permission::getInstance()->verifPerm('PermsForum', 'general', 'addCategorie') and !$_SESSION['mode']) : ?>
                ...
                <!-- Ajouter une forum -->
                <a class="btn btn-reverse no-hover col-5 ml-auto bg-light" role="button" data-toggle="collapse"
                   href="#add_categorie" aria-exepanded="false" aria-controls="add_categorie">
                    Ajouter un Forum
                </a>
                        ...
                        <form action="?action=create_cat" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row my-2">
                                    ...
                                    <input type="text" name="nom" id="nomCat" maxlength="40"
                                ...
                                <div class="form-row my-2">
                                    ...
                                    <input type="text" name="img" id="img" maxlength="300"
                    ...
                    <div class="card">
                        <form action="?action=create_forum" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <input type="text" name="nom" id="nomFo" maxlength="80"
                                       class="form-control custom-text-input" required>
