                                    ...
                                    <div style="<?= ($i == 0) ? '' : 'display: none;'; ?>" id="joueur<?= $i; ?>">
                                        ...
                                        ?>
                                                <img class="mr-3"
                                                        ...
                                                        style="width: 16px; height: 16px;" /><?= $value; ?>
                                                        <?= Permission::getInstance()->gradeJoueur($value); ?>
                                                <br/>
                                            <?php } ?>
                                    </div>
                                </li>
            ...
            <div class="col-md-9">
                <div class="tab-content">
                    <?php for ($i = 0; $i < count($jsonCon); $i++) {
                        ...
                        <div id="server-<?= $i ?>" class="tab-pane fade <?php if ($i == 0) echo 'in active show'; ?>"
                             aria-expanded="false">
                            <div class="card">
                                ...
                                <div class="card-body" id="msgChat<?= $i; ?>">
                                            ...
                                            <div class="media">
                                                <p class="username">
                                                    <img class="mr-3"
                                                         ...
                                                         style="width: 32px; height: 32px;" alt="avatar de l'auteur"/>
                                        ...
                                        <div class="tab-pane fade in show" aria-expanded="false">
                                            <div class="alert alert-info">
                                                <div class="text-center">
                                                    <i class="fas fa-info-circle"></i> La connexion au serveur ne peut
                                                    pas être établie avec ce protocole.
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <?php } elseif ($messages == "erreur") { ?>
                                        ...
                                        <div class="tab-pane fade in show" aria-expanded="false">
                                            <div class="info-page bg-info">
                                                <div class="text-center">
                                                    <i class="fas fa-info-circle"></i> Aucun message n'a été envoyé sur
                                                    ce serveur !
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <div class="tab-pane fade in show" aria-expanded="false">
                                            <div class="alert alert-info">
                                                <div class="text-center">
                                                    <i class="fas fa-info-circle"></i> La connexion au serveur n'a pas
                                                    pu être établie.
                                                </div>
                                            </div>
                                        </div>
                ...
                <?php if (Permission::getInstance()->verifPerm("connect")) : ?>
                    ...
                    <form action="?action=sendChat" method="POST">
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-md-8">
                                    <input type="text" name="message" placeholder="Envoyez votre message..." max="100"
                                           class="form-control">
                                </div>
                                <div class="col-md-4">
