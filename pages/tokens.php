                                            ...
                                            <div class="card bg-dark">
                                                ...
                                                <div class="card-footer">
                                                    <form action="<?= $lien; ?>" method="post">
                                                        ...
                                                        <?php endforeach; ?>
                                                        <input type="submit" class="btn btn-success w-100" value="Acheter !" />
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="collapse" id="paysafecard<?= $value['id']; ?>">
                                                <div class="card">
                                                    <form action="?action=buyPaysafecard" method="POST">
                                                        ...
                                                        <div class="card-footer">
                                                            <button type="submit" class="btn btn-success btn-reverse w-100">Envoyer !</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
