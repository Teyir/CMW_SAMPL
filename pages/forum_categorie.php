...
<section class="page" id="ForumCategorie">
    <div class="container-fluid col-md-9 col-lg-9 col-sm-10">
        <div class="row">

            <!-- Si on est en mode joueur ça nous affiche un message-->
            <?php if ($_SESSION['mode']) : ?>
                <div class="alert alert-warning w-80 mx-auto mt-3" role="alert">
                    <p style="margin-bottom: 0;" class="text-center">Vous êtes en Mode Joueur. Pour changer de mode,
                        passez sur la page forum.</p>
                </div>
            <?php endif; ?>
                ...
                <ol class="breadcrumb bg-dark">
                    ...
                    <?php if (isset($id_sous_forum)) : ?>
                        <li class="breadcrumb-item"><a
                                    href="?page=forum_categorie&id=<?= $id ?>"> <?= $categoried['nom'] ?> </a></li>
                    <?php else : ?>
                                ...
                                <td>
                                    ...
                                    <?php if ($sousforumd[$a]['img'] == NULL) : ?>
                                        <a style="font-size: 28px;"
                                           href="?&page=forum_categorie&id=<?= $id; ?>&id_sous_forum=<?= $sousforumd[$a]['id']; ?>">
                                            <i class="far fa-comment-dots"></i>
                                        </a>
                                    <?php else : ?>
                                        <a style="font-size: 28px;"
                                           href="?page=forum_categorie&id=<?= $id; ?>&id_sous_forum=<?= $sousforumd[$a]['id']; ?>"><i
                                                    class="<?= $sousforumd[$a]['img']; ?>"></i>
                                        </a>
                                    <?php endif; ?>
                                </td>
                                        ...
                                        <div class="mx-auto d-flex align-self-center">
                                            ...
                                            <div class="dropdown d-inline ml-1">
                                                <button type="button" class="btn btn-main dropdown-toggle"
                                                        id="Perms<?= $categorie[$j]['id']; ?>" data-toggle="dropdown"
                                                ...
                                                <div class="dropdown-menu">
                                                    <form action="?action=modifPermsSousForum" method="POST">
                                                        <input type="hidden" name="id"
                                                               value="<?= $sousforumd[$a]['id']; ?>"/>
                                                        <a class="dropdown-item"><input
                                                                    class="form-control custom-text-input" type="number"
                                                                    name="perms"
                                                                    value="<?= $sousforumd[$a]['perms']; ?>"
                                            ...
                                            <div class="dropdown d-inline ml-1">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item"
                                                       href="?action=ordreSousForum&ordre=<?= $sousforumd[$a]['ordre']; ?>&id=<?= $sousforumd[$a]['id']; ?>&id_cat=<?= $sousforumd[$a]['id_categorie']; ?>&modif=monter">
                                                        <i class="fas fa-arrow-up"></i> Monter d'un cran</a>
                                                    <a class="dropdown-item"
                                                       href="?action=ordreSousForum&ordre=<?= $sousforumd[$a]['ordre']; ?>&id=<?= $sousforumd[$a]['id']; ?>&id_cat=<?= $sousforumd[$a]['id_categorie']; ?>&modif=descendre">
                                                        <i class="fas fa-arrow-down"></i> Descendre d'un cran</a>
                                                </div>

                                            </div>

                                            <button type="button"
                                                    onclick="openModalEditSousForum(<?= $id; ?>,<?= $sousforumd[$a]['id']; ?>, <?= $a; ?>, '<?= $sousforumd[$a]['nom']; ?>', <?php if ($sousforumd[$a]['img'] == NULL) {
                                                        echo 'null';
                                                    } else {
                                                        echo "'" . $sousforumd[$a]['img'] . "'";
                                            ...
                                            <?php if ($sousforumd[$a]['close'] == 0) : ?>
                                                ...
                                                <a href="?action=lock_sf&id_f=<?= $sousforumd[$a]['id_categorie']; ?>&id=<?= $sousforumd[$a]['id']; ?>&lock=1"
                                                   title="Fermer le sous-forum" class="btn btn-reverse ml-1 no-hover">
                                                    <i class="fas fa-unlock-alt" aria-hidden="true"></i>
                                                </a>

                                            <?php else : ?>

                                                <a href="?action=unlock_sf&id_f=<?= $sousforumd[$a]['id_categorie']; ?> &id=<?= $sousforumd[$a]['id']; ?>&lock=0"
                                                   title="Ouvrir le sous-forum" class="btn btn-reverse ml-1 no-hover">
                                            ...
                                            <a class="btn btn-danger no-hover ml-1"
                                               href="?action=remove_sf&id_cat=<?php echo $id; ?>&id_sf=<?php echo $sousforumd[$a]['id']; ?>">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="float-right">
                        <a class="btn btn-main px-4" role="button" data-toggle="collapse" href="#sous_cat"
                        ...
                        <form action="?action=create_sf" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-row ">
                                    ...
                                    <input type="text" required class="form-control custom-text-input" name="nom"
                                           id="nomSF" maxlength="40"/>
                                </div>

                                <div class="form-row py-2">
                                    <label class="control-label" for="img">Icône</label>
                                    <input type="text" maxlength="300" name="img" id="img"
        ...
        <div class="row">
            ...
            <h3>
                Les topics
                de <?= $categoried['nom'] ?> <?= (isset($id_sous_forum)) ? ' - ' . $sousforumd['nom'] : ''; ?>
            </h3>
            <?php
                            ...
                            <tr>
                                <?php if (Permission::getInstance()->verifPerm('PermsForum', 'moderation', 'selTopic') && !$_SESSION['mode']) : ?>
                                    <td>
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input name="selection" id="selection-<?= $topicd[$i]['id']; ?>"
                                                   type="checkbox" class="custom-control-input"
                                                   value="<?= $topicd[$i]['id']; ?>"/>
                                            <label for="selection-<?= $topicd[$i]['id']; ?>"
                                ...
                                <td>
                                    <a href="?page=profil&profil=<?= $topicd[$i]['pseudo']; ?>">
                                        <img src="<?= $_ImgProfil_->getUrlHeadByPseudo($topicd[$i]['pseudo'], 42); ?>"
                                             style="width: 42px; height: 42px;" alt="avatar de <?= $topicd[$i]['pseudo']; ?>"
                                             title="<?= $topicd[$i]['pseudo']; ?>"/>
                                    </a>
                                </td>
                                        ...
                                        <div class="row my-2">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type="radio" class="custom-control-input" id="ouiEp"
                                                           name="epingle" value="1">
                                                    <label class="custom-control-label" for="ouiEp">Oui</label>
                                                </div>

                                                <div class="custom-control custom-radio">
                                                    <input type="radio" class="custom-control-input" id="nonEp"
                                                           name="epingle" value="0">
                                    ...
                                    <?php if (Permission::getInstance()->verifPerm('PermsForum', 'moderation', 'closeTopic')) : ?>
                                        ...
                                        <div class="row my-2">
                                            <div class="col-12">
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type='radio' class="custom-control-input" name='close'
                                                           value='1' id='yes'/>
                                    ...
                                    <?php if (Permission::getInstance()->verifPerm('PermsForum', 'moderation', 'deleteTopic')) : ?>
                                        ...
                                        <div class="row my-2">
                                            <div class="col-12">
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input type='radio' class="custom-control-input" name='remove'
                                                           value='1' id='ouiSP'/>
                ...
                <nav aria-label="Page forum catégorie">
                    <ul class="pagination">
                        ...
                        for ($i = 1; $i <= $count_topic_nbrOfPages2; $i++) : ?>
                            <li class="page-item">
                                <a class="page-link"
                                   href="?&page=forum_categorie&id=<?= $id ?> <?= (isset($id_sous_forum)) ? "&id_sous_forum=$id_sous_forum" : ""; ?>&page_topic=<?= $i; ?>">
                                    <?= $i; ?>
                                </a>
                            </li>
                        <?php endfor; ?>
            ...
            <?php else : ?>
                ...
                <!-- Si il n'y à aucuns messages on poste ce message -->
        ...
        <div class="row">
            ...
            <!-- Poster un topic dans la categorie -->
                <div class="card col-8 mx-auto bg-dark">
                    <form action="?&action=create_topic" method="post">

                        <div class="card-header">
                            <h4>
                                Poster un topic dans la
                                catégorie <?= $categoried['nom']; ?> <?= (isset($id_sous_forum)) ? ' et le sous-forum ' . $sousforumd['nom'] : '' ?>
                            </h4>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <input type="hidden" name="sous-forum"
                                   value="<?= (isset($id_sous_forum)) ? $id_sous_forum : 'NULL' ?>"/>

                            <div class="form-row my-3">
                                <label for="nom">
                                    Rentrez le nom de votre sujet/topic
                                </label>
                                <input type="text" class="form-control custom-text-input" id="nom" name="nom"
                                       placeholder="Le titre de votre topic ici" required/>
                            </div>

                            <div class="col-md-12 text-center">

                                <textarea data-UUID="0003" id="ckeditor" name="contenue"
                                          style="height: 350px; margin: 0px; width: 100%;">
                                </textarea>
            ...
            <!-- Si on est pas connecté ça nous affiche un petit message -->
            <?php
