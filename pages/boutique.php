                            ...
                            <?php if (isset($categories)) : ?>
                                ...
                                <?php for ($j = 0; $j < count($categories); $j++) : ?>
                                    ...
                                    <li class="nav-item<?= ($j == 0) ? ' active' : '' ?>">
                                        <a href="#categorie-<?= $j ?>" class="nav-link<?= ($j == 0) ? ' active' : '' ?>"
                                           data-toggle="tab">
            ...
            <div class="col-md-12 col-lg-6 col-sm-12 mb-5">
                <?php if (isset($categories)) : ?>
                    <div class="offres tab-content">
                        ...
                        <?php for ($j = 0; $j < count($categories); $j++) : ?>
                            <div id="categorie-<?= $j ?>"
                                 class="tab-pane fade <?= ($j == 0) ? ' in active show' : ''; ?>"
                                        ...
                                        if ($offresTableau[$i]['categorie'] == $categories[$j]['id']) :
                                            ...
                                            <div class="col-md-4" style="margin-top: 15px">
                                                <div class="card">
                                                    ...
                                                    <!-- Footer de l'article, on affiche le boutton d'achat ou non -->
                                                    <div class="card-footer text-center card_footer_shop">
                                                        <?php if (Permission::getInstance()->verifPerm("connect")) : ?>
                                                            <?php if (isset($offresTableau[$i]['buy'])) { ?>
                                                                ...
                                                                <p class="bg-dark">Vous devez d'abord
                                                                    acheter: <?php foreach ($offresTableau[$i]['buy'] as $value) {
                                                                        echo $offresByGet[$value];
                                                                    } ?></p>

                                                            <?php } else if (isset($offresTableau[$i]['maxbuy'])) { ?>

                                                                <p class="bg-dark">Vous avez dépassé le nombre d'achat
                                                                    maximum de cette offre</p>

                                                            <?php } else if ($offresTableau[$i]['nbre_vente'] == 0) { ?>

                                                                <p class="bg-dark">Rupture de stock</p>

                                                            <?php } else { ?>

                                                                <!-- Boutton d'achat si toutes les conditions sont remplies -->
                                                                <a href="?action=addOffrePanier&offre=<?= $offresTableau[$i]['id'] ?>&quantite=1"
                                                                   class="btn btn-primary btn-block btn-sm mb-2 btn_shop">
                                                        ...
                                                        <?php else : ?>
                                                            ...
                                                            <a data-toggle="modal" data-target="#ConnectionSlide"
                                                               class="btn btn-primary mb-2 btn-sm rounded">
                                                                <span class="fas fa-sign-in-alt"></span> Se connecter
                                                            </a>

                                                        <?php endif; ?>

                                                        <button class="btn btn-primary btn-block btn-sm">Prix
                                                            : <?= ($offresTableau[$i]['prix'] == '0' ? 'gratuit' : $offresTableau[$i]['prix']) ?>
                                                            <i class="fas fa-gem"></i></button>
                                                    </div>
                                ...
                                <?php if ($categories[$j]['offres'] == 0) : ?>
                                    ...
                                    <div class="alert alert-info">
                                        <i class="fas fa-info-circle"></i> Aucune offre disponible dans
                                        : <?= $categories[$j]['titre'] ?>
                                    </div>
                                <?php endif; ?>
                ...
                <?php else : ?>
                    ...
                    <!-- Si il n'y à pas de catégorie disponible -->
                    <div class="alert alert-info text-center"><i class="fas fa-info-circle"></i>
                ...
                <div class="card">
                    ...
                    <div class="card-body player-shop">
                        <?php if (Permission::getInstance()->verifPerm("connect")) : ?>
                            ...
                            <a href="<?= $_Panier_->compterArticle() > 0 ? '?page=panier' : '#' ?>"
                               class="btn btn-primary btn-block btn-sm rounded">
                                Panier
                        ...
                        <div class="categorie-content">
                            <div class="categorie-item text-justify">
                                ...
                                <div class="categorie-item">
                                    <a data-toggle="modal" data-target="#ConnectionSlide" class="btn btn-primary">
