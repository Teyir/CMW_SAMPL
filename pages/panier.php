                    ...
                    <?php else :
                        ...
                        for ($i = 0; $i < $nbArticles; $i++) :
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="?action=supprItemPanier&id=<?= htmlspecialchars($_SESSION['panier']['id'][$i]); ?>"
                        ...
                        <div class="card-footer bg-dark" >
                            <div class="text-right">
                                ...
                                <a href="?action=achat" class="btn btn-reverse w-100 mb-2 no-hover"
                                   style="background-color: #20d435; color: whitesmoke">
                                    Passer à l'achat
                                </a>
