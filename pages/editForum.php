...
if (Permission::getInstance()->verifPerm("connect") and isset($_GET['id'], $_GET['objet'])) :
    ...
    if ($AdminForum->verifEdit($objet, $id, $_Joueur_)) :
        ...
        <section class="page" id="editForum">
                    ...
                    <form action="?action=editPost" method="POST" class="w-100 m-3">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header bg-dark">
                                <h4 class="ml-0"><i class="fas fa-paragraph"></i>
                                    Edition de votre <?= ($objet == 1) ? 'topic' : 'réponse'; ?></h4>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <textarea data-UUID="0002" id="ckeditor" name="contenue"
                                          style="height: 275px; margin: 0px; width: 100%;"><?= $donnee['contenue']; ?>
                                </textarea>
