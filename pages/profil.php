...
<section class="page" id="Profil">
    <div class="container-fluid col-md-9 col-lg-9 col-sm-10">
        ...
        <div class="row">
                            ...
                            <div class="row no-gutters">
                                <div class="col-md-4">
                                    <img src="<?php echo $skin ?>" class="card-img profile-skin3d"
                                         alt="Skin de <?= $joueurDonnees['pseudo'] ?>" style="margin-left: 7px;">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <p class="card-title"><?= $gradeSite ?> <?= htmlspecialchars($joueurDonnees['pseudo']); ?></p>
                                        <br>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="row">
                                                ...
                                                <ul class="categorie-content nav nav-tabs">
                                                    ...
                                                    <li class="categorie-item nav-item">
                                                        <a href="#editPersonal" class="nav-link categorie-link active"
                                                           data-toggle="tab" aria-controls="editPersonal"
                                                           aria-selected="true">
                                                    ...
                                                    <li class="categorie-item nav-item">
                                                        <a href="#editOptionnal" class="nav-link categorie-link"
                                                           data-toggle="tab"
                                        ...
                                        <div class="col-md-12 col-lg-8 col-sm-12 mb-3 ml-lg-3">
                                            <!-- Contenu de la modification du compte -->
                                            <div class="tab-content">
                                                ...
                                                <div id="editPersonal" class="tab-pane fade show active" role="tabpanel"
                                                    ...
                                                    <form class="form-horizontal" method="post"
                                                        ...
                                                        <h5 class="mt-4 mb-0">Modifier votre mot de passe : <small>(Laisser
                                                                vide
                                                        ...
                                                        <span class="input-group-prepend">
                                                            ...
                                                            <div class="col-md-12 mb-2">
                                                                <label for="mdpConfirme"> Confirmation Mot de
                                                                    passe </label>
                                                                <div class="input-group">
                                                        <span class="input-group-prepend">
                                                            <div class="input-group-text bg-main border-0">
                                                        ...
                                                        <h5 class="mt-4 mb-0">Modifier votre mail : <small>(Laisser vide
                                                                pour ne
                                                        ...
                                                        <span class="input-group-prepend">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <?php else : ?>
                                                                    ...
                                                                    <button type='submit'
                                                                            class="btn btn-success btn-reverse form-control"
                                                                            name="changeNewsletter"
                                                            ...
                                                            <div class="row w-100">
                                                                <div class="col-12 mt-4">
                                                                    <button type="submit"
                                                                            class="btn btn-light validerChange w-100 form-control">
                                                ...
                                                <div id="editOptionnal" class="tab-pane fade" role="tabpanel"
                                                    ...
                                                    <form class="form-horizontal" method="post"
                                                          action="?&action=changeProfilAutres"
                                                          role="form">
                                                        ...
                                                        <div class="form-row wys-content">
                                                            ...
                                                            <div class="col-md-12 text-center wys-options">
                                                                <textarea data-UUID="0005" id="ckeditor"
                                                                          name="signature"
                                                                          style="height: 275px; margin: 0px; width: 100%;"><?= $joueurDonnees['signature'] ?></textarea>
            ...
            <?php else : ?>
                <div class="col-md-12 col-lg-6 col-sm-12 mb-5 mx-auto ">
                        ...
                        <div class="card bg-dark">
                            <div class="card-container text-center">
                                ...
                                <label for="img_profil">
                                    <input type="file" class="form-control-file d-none" name="img_profil"
                                           id="img_profil"
                                ...
                                <div class="card-footer">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-sm btn-primary"><i
                                                    class="fa fa-upload"></i> Envoyer
                                        </button>
                                        <a class="btn btn-sm btn-danger" href="?action=removeImgProfil"><i
